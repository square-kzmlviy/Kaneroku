class BalanceSummarizeController < ApplicationController
    def index
        ...
        @beginning_of_month = @this_day.beginning_of_month
        @end_of_month = @this_day.end_of_month
        ...
        this_day_total = current_user.money_balances
                                     ...
                                     .where('categories.is_income = ?',false)
                                     .sum(:value)
        this_month_total = current_user.money_balances
        .left_joins(:category)
        ...
        render json: {daily_total:this_day_total,weekly_total:this_week_total,monthly_total:this_month_total,week_history:this_week_history,week_dates:this_week_dates},status: 200
    end
end
